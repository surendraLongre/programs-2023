...
if left_right=="left":
    ...
    if wait_swim=="wait":
        ...
        if color=="red":
            ...
            print("wrong option. You died Game Over.")
    elif wait_swim=="swim":
        print("you eaten by crocodiles.Game Over.")
    else:
        print("wrong option. You eaten by your lover. Game Over")
elif left_right=="right":
    print("You eaten by zombies. Game Over.")
